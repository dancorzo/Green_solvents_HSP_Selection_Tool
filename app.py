                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.H3(
                                    "OPV Green Solvent Selection Tool",
                                    className="uppercase title",
                                ),
                                html.Span("Hover ", className="uppercase bold"),
                                html.Span(
                                    "over a solvent in the graph to see its structure and properties"
                                ),
                                html.Br(),
                                html.Span("Select ", className="uppercase bold"),
                                html.Span(
                                    "a solvent in the dropdown to add it to the candidates at the bottom."
                                ),
                            ]
                        )
                    ],
                        ...
                        html.Div(
                            [
                                dcc.RadioItems(
                                    id="charts_radio",
                                    options=[
                                        {"label": "3D Scatter", "value": "scatter3d"},  # Select 3D scatter
                                        {"label": "2D Scatter", "value": "scatter"},  #Select 2D Scatter
                                        #{"label": "2D Histogram","value": "histogram2d",}, #Select 2D Histogram
                                    ],
